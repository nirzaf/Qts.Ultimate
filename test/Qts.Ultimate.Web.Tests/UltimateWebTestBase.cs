...
{
    public abstract class UltimateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UltimateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UltimateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UltimateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UltimateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UltimateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UltimateDbContext, Task<T>> func)
        {
            T result;
